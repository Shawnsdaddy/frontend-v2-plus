...
const render_product = (option) => option.label
...
const fia_list = computed(() => {
  for (let i = 1; i <= 4; ++i) {
    const dorm = current_plan.value[`dormitory_${i}`]
    if (!dorm?.plans) continue
    for (let j = 0; j < dorm.plans.length; ++j) {
      if (dorm.plans[j].agent === '菲亚梅塔') {
        return dorm.plans[j].replacement
      }
    }
  }
  return []
        ...
        <div class="left_contain" v-for="row in 3">
          ...
          >
            <div
              ...
              :style="{
                'background-image': current_plan[r]?.product ? `url(/product/${current_plan[r].product}.png)` : 'none'
              }"
            ></div>
            <div
            ...
            >
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan[r]?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
                        :char-id="getCharId(i.agent)"
                        :size="45"
                        class="operator-avatar"
                      />
                      <img
                        v-else
                        :src="getAvatarUrl(i.agent)"
                        width="45"
                        height="45"
                        draggable="false"
                      />
        ...
        <div class="mid_contain">
         ...
         >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.central?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
                        ...
                        class="operator-avatar"
                      />
                      <img v-else :src="getAvatarUrl(i.agent)" width="45" height="45" draggable="false" />
                    </div>
                  </div>
                </template>
              </div>
        ...
        <div class="mid_contain">
          ...
          >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.dormitory_1?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
        ...
        <div class="mid_contain">
          ...
          >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.dormitory_2?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
        ...
        <div class="mid_contain">
          ...
          >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.dormitory_3?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
        ...
        <div class="mid_contain">
          ...
          >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.dormitory_4?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
        ...
        <div class="right_contain">
          ...
          >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.meeting?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
        ...
        <div class="right_contain">
          ...
          >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.factory?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
        ...
        <div class="right_contain">
          ...
          >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.contact?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
        ...
        <div class="right_contain">
          ...
          >
            <div>
              ...
              <div class="avatars">
                <template v-for="(i, idx) in current_plan.train?.plans ?? []" :key="idx">
                  <div class="avatar-wrapper" v-if="i?.agent">
                    <div class="avatar-inner" :style="{ 'border-bottom': color_map[i.group] }">
                      <operator-avatar
                        v-if="getCharId(i.agent)"
